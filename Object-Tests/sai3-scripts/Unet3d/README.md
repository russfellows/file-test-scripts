...
**sai3-bench** should be installed natively on your system.

See installation instructions at: https://github.com/russfellows/sai3-bench#installation

See parent documentation for tool details and configuration examples.
