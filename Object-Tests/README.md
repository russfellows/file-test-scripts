...
- CLI tool (s3-cli) for all storage backends (S3, Blob_Provider, Object_Storage, local file, DirectIO)
...
- Multi-protocol testing (S3, Blob_Provider, Object_Storage, local storage)
